...
date) to a :class:`~stock_trading_agent.agents.schemas.TradeDecision`. This is exactly
...
from stock_trading_agent.data.indicators import annualised_volatility, atr, bollinger, rsi, sma
